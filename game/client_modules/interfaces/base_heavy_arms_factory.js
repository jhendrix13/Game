...
(function(){
    function base_heavy_arms_factory(Core){
        this.Core = Core;
        this.id = 'base_heavy_arms_factory';
    ...
    base_heavy_arms_factory.prototype.load = function(){
        var Player = this.Core.Player;
        var city = Player.cities[Player.current_city];
        var resource = this.Core.Resources.base.buildings['heavy_arms_factory'];
        ...
        var html = '<div name="interface-'+ this.id +'" class="interface" style="width:550px;">';
            ...
            html += '<div name="tab-weapons" class="tab">Weapons</div><div name="tab-vehicles" class="tab">Vehicles</div><div name="tab-missiles" class="tab">Missiles</div>';
            html += '</div>';
            ...
            html += '<div name="content-missiles" class="hidden">';
            var missiles = this.Core.Game.gameCfg.military_missiles;
            
            for(var missile in missiles){
                var obj = missiles[missile];
                
                if(obj.classification === 'heavy'){
                    html += '<div style="float:left;margin:8px;">';
                    html += '<img name="item-missiles/'+ missile +'" src="'+ obj.thumbnail_src +'" style="width:64;height:64;cursor:pointer;">';
                    html += '<div style="margin:5px;">';
                    html += '<table cellpadding="0" style="color:white;">';
                    html += '<tr style="font-size:18px;color:yellow;"><td colspan="2">'+ obj.name +'</td></tr>';
                    html += '<tr><td>Attack</td><td>&nbsp;'+ fn_numberFormat(obj.attack) +'</td></tr>';
                    html += '<tr><td>Range</td><td>&nbsp;'+ fn_numberFormat(obj.range) +'</td></tr>';
                    html += '<tr><td>Speed</td><td>&nbsp;'+ fn_numberFormat(obj.speed) +'</td></tr>';
                    html += '<tr><td>PPM</td><td>&nbsp;'+ fn_numberFormat(obj.ppm) +'</td></tr>';
                    html += '</table>';
                    html += '</div>';
                    html += '</div>';
        ...
        $(document).on('click', 'div[name="interface-'+ this.id +'"] button[name="ok"]', function(){
            this.Core.InterfaceManager.unloadInterface('base_heavy_arms_factory');
        }.bind(this));
    ...
    base_heavy_arms_factory.prototype.showItem = function(e){
        var Player = this.Core.Player;
        var city = Player.cities[Player.current_city];
    ...
    base_heavy_arms_factory.prototype.updateCost = function(e){
        var object = $(e.target);
    ...
    base_heavy_arms_factory.prototype.purchaseItem = function(e){
        var Player = this.Core.Player;
        var city = Player.cities[Player.current_city];
    ...
    base_heavy_arms_factory.prototype.cancelProduction = function(e){
    ...
    base_heavy_arms_factory.prototype.back = function(e){
    ...
    base_heavy_arms_factory.prototype.showTab = function(e, name){
    ...
    base_heavy_arms_factory.prototype.unload = function(){
    ...
    Client.interfaces['base_heavy_arms_factory'] = base_heavy_arms_factory;
})();
